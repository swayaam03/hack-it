...
const mockIssues: Issue[] = [
  {
    id: "1",
    title: "Potholes",
    description: "Multiple reports of vehicles hitting potholes",
    status: "open",
    priority: "critical",
  ...
  {
    id: "2",
    title: "Road sign not visible",
    description: "Faded road sign causing confusion",
    status: "in-progress",
    priority: "high",
  ...
  },
  {
    id: "3",
    title: "Water leakage",
    description: "Fix water leakage near main street",
    status: "in-progress",
    priority: "medium",
  ...
  },
  {
    ...
    description: "Garbage not collected on scheduled days",
    status: "resolved",
    priority: "medium",
  ...
  {
    id: "5",
    title: "Road lighting issue",
    description: "Streetlights not functioning properly",
    status: "closed",
    priority: "low",
  ...
  },
  {
    id: "6",
    title: "Road blockage",
    description: "Tree fallen blocking the road",
    status: "open",
    priority: "high",
